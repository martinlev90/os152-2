...
main(void)
{
  ...
  10:	00 
  11:	c7 04 24 e2 08 00 00 	movl   $0x8e2,(%esp)
  18:	e8 b6 03 00 00       	call   3d3 <open>
  ...
  30:	00 
  31:	c7 04 24 e2 08 00 00 	movl   $0x8e2,(%esp)
  38:	e8 9e 03 00 00       	call   3db <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 e2 08 00 00 	movl   $0x8e2,(%esp)
  4c:	e8 82 03 00 00       	call   3d3 <open>
  }
  dup(0);  // stdout
  51:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  58:	e8 ae 03 00 00       	call   40b <dup>
  dup(0);  // stderr
  5d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  64:	e8 a2 03 00 00       	call   40b <dup>

  for(;;){
    printf(1, "init: starting sh\n");
  69:	c7 44 24 04 ea 08 00 	movl   $0x8ea,0x4(%esp)
  70:	00 
  71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  78:	e8 96 04 00 00       	call   513 <printf>
    pid = fork();
  7d:	e8 09 03 00 00       	call   38b <fork>
  82:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    printf(1,"here %d\n" , pid);
  86:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8a:	89 44 24 08          	mov    %eax,0x8(%esp)
  8e:	c7 44 24 04 fd 08 00 	movl   $0x8fd,0x4(%esp)
  95:	00 
  96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  9d:	e8 71 04 00 00       	call   513 <printf>
    if(pid < 0){
  a2:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  a7:	79 19                	jns    c2 <main+0xc2>
      printf(1, "init: fork failed\n");
  a9:	c7 44 24 04 06 09 00 	movl   $0x906,0x4(%esp)
  b0:	00 
  ...
  c7:	75 2d                	jne    f6 <main+0xf6>
      ...
      exec("sh", argv);
  c9:	c7 44 24 04 84 0b 00 	movl   $0xb84,0x4(%esp)
  d0:	00 
  d1:	c7 04 24 df 08 00 00 	movl   $0x8df,(%esp)
  d8:	e8 ee 02 00 00       	call   3cb <exec>
      printf(1, "init: exec sh failed\n");
  dd:	c7 44 24 04 19 09 00 	movl   $0x919,0x4(%esp)
  e4:	00 
  ...
  f6:	eb 14                	jmp    10c <main+0x10c>
      printf(1, "zombie!\n");
  f8:	c7 44 24 04 2f 09 00 	movl   $0x92f,0x4(%esp)
  ff:	00 
 ...
 126:	e9 3e ff ff ff       	jmp    69 <main+0x69>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ac:	0f b6 80 8c 0b 00 00 	movzbl 0xb8c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 609:	75 09                	jne    614 <printf+0x101>
          s = "(null)";
 60b:	c7 45 f4 38 09 00 00 	movl   $0x938,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d5:	a1 a8 0b 00 00       	mov    0xba8,%eax
...
free(void *ap)
{
 ...
 7a0:	a3 a8 0b 00 00       	mov    %eax,0xba8
}
 7a5:	c9                   	leave  
 7a6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7f3:	e8 ce fe ff ff       	call   6c6 <free>
  return freep;
 7f8:	a1 a8 0b 00 00       	mov    0xba8,%eax
}
 7fd:	c9                   	leave  
 7fe:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 811:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 814:	a1 a8 0b 00 00       	mov    0xba8,%eax
 819:	89 45 f0             	mov    %eax,-0x10(%ebp)
 81c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 820:	75 23                	jne    845 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 822:	c7 45 f0 a0 0b 00 00 	movl   $0xba0,-0x10(%ebp)
 829:	8b 45 f0             	mov    -0x10(%ebp),%eax
 82c:	a3 a8 0b 00 00       	mov    %eax,0xba8
 831:	a1 a8 0b 00 00       	mov    0xba8,%eax
 836:	a3 a0 0b 00 00       	mov    %eax,0xba0
    base.s.size = 0;
 83b:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 842:	00 00 00 
  }
 ...
 898:	a3 a8 0b 00 00       	mov    %eax,0xba8
      return (void*)(p + 1);
 ...
 8a3:	eb 38                	jmp    8dd <malloc+0xde>
    ...
    if(p == freep)
 8a5:	a1 a8 0b 00 00       	mov    0xba8,%eax
